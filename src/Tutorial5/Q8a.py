...
#   a) When we think that some commands may fail, we create an exception handler for the errors we expect using
...
#           Exception handler
#
#   The above construct does not specify a specific exception (error) to handle, so the exception handler is
#   used for any errors that occur while executing the Python commands.
#       try:
#           Python commands
